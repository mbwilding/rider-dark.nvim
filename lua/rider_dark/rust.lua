...
local syntax_map = {
    ["@namespace.rust"] = { fg = colors_custom.crate },
    ["@lsp.typemod.namespace.crateRoot.rust"] = { fg = colors_custom.crate },
    ["@lsp.mod.library.rust"] = { fg = colors_custom.module },
    ...
    ["@lsp.typemod.namespace.declaration.rust"] = { fg = colors_custom.module },
    ...
    ["@lsp.type.namespace.rust"] = { fg = colors_custom.module },
    ...
    ["@lsp.typemod.generic.attribute.rust"] = { fg = colors_custom.module },
    ["@lsp.typemod.function.attribute.rust"] = { fg = colors.method },
    ["@lsp.typemod.deriveHelper.attribute.rust"] = { fg = colors_custom.crate },
}
